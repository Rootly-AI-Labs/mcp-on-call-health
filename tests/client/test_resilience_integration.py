...
from oncallhealth_mcp.client.base import OnCallHealthClient
from oncallhealth_mcp.client.circuit_breaker import CircuitBreakerOpenError
...
class TestResilienceIntegrationCircuitBreaker:
    ...
    async def test_circuit_breaker_opens_on_persistent_failure(self, respx_mock):
        ...
        """
        from oncallhealth_mcp.client.retry import RetriableHTTPError
